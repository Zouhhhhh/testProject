...
<html>
  ...
  <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		...
		<hr class="hr"/>
		<div id="pageControl">
			<div class="pageControl_item">每页<span id="dataPrePage">${dataPrePage }</span>条数据</div>
			<div class="pageControl_item" id="last">最后一页</div>
			<div class="pageControl_item" id="next">下一页</div>
			<div class="pageControl_item"><span id="currentPage">${currentPage }</span>/<font id="pages">${pages }</font></div>
